...
**Delightful Loading Screen** — это веб-приложение, реализующее анимированный экран загрузки в стиле мессенджера Slack с вращающимся индикатором. Проект разработан в рамках производственной практики по ПМ.01 «Разработка модулей программного обеспечения для компьютерных систем». Приложение включает систему авторизации пользователей с валидацией данных, блокировкой после 3 неудачных попыток, восстановлением пароля и поддержкой светлой/темной темы.
